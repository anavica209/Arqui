...
;	mov eax,4		Servicio 4: escritura (write). Los par�tros necesarios son:
;//	mov bx,1		   EBX: unidad de salida (1: salida est�ar)
;//	mov ecx,oraci�   ECX: Puntero a un �a de memoria donde se encuentran los caracteres a mostrar.
;//	mov edx,100		   EDX: N� m�mo de caracteres a mostrar. 
	push	ebp
	mov	ebp, esp
;	//servicio
	push eax
...
_read_character:
;//mov eax,3	Servicio 3: lectura (read). Los par�tros necesarios son:
;//mov bx,0	    EBX: unidad de entrada (0: entrada est�ar).
;//mov ecx,oraci�   ECX: Puntero a un �a de memoria donde se dejar�los caracteres obtenidos.
;//mov edx,100 	    EDX: N� m�mo de caracteres a leer.
	push	ebp
	mov	ebp, esp
;	//servicio
	push eax
